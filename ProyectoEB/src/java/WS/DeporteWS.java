...
/**
 * Jersey REST client generated for REST resource:DeporteFacadeREST
 * [entidades.deporte]<br>
 * USAGE:
 * <pre>
 *        DeporteWS client = new DeporteWS();
...
public class DeporteWS {
    ...
    public DeporteWS() {
        ...
        webTarget = client.target(BASE_URI).path("entidades.deporte");
    }
