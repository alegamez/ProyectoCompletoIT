...
public class Evento implements Serializable {
    ...
    @JoinTable(name = "evento_personalseguridad", joinColumns = {
        @JoinColumn(name = "id_evento", referencedColumnName = "id")}, inverseJoinColumns = {
        @JoinColumn(name = "id_personalSeguridad", referencedColumnName = "id")})
    @ManyToMany
    private Collection<Personalseguridad> personalseguridadCollection;
    ...
    @XmlTransient
    public Collection<Personalseguridad> getPersonalseguridadCollection() {
        return personalseguridadCollection;
    }

    public void setPersonalseguridadCollection(Collection<Personalseguridad> personalseguridadCollection) {
        this.personalseguridadCollection = personalseguridadCollection;
    }
